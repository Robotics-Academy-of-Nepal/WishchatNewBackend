...
def send_invitation_email(invitation, frontend_url):
    ...
    html_message_path = os.path.join('D://', 'open-ai', 'openai_backend', 'wishchat', 'registration', 'templates', 'emails', 'invitation_email.html')
    plain_message_path = os.path.join('D://', 'open-ai', 'openai_backend', 'wishchat', 'registration', 'templates', 'emails', 'invitation_email.txt')
