...
urlpatterns = [
    ...
    path(
        ...
        ToggleEnterpriseStatusView.as_view(),
    ...
    path(
        "organization/members/<int:member_id>/",
    ...
    path(
        "<int:org_id>/token-usage/",
        OrganizationTokenCountView.as_view(),
        name="OrganizationTokenCount",
    ),
    path(
        "chatbots/<int:chatbot_id>/token-usage/",
        ChatbotTokenCountView.as_view(),
        name="ChatbotTokenCount",
    ),
    path(
        "<int:chatbot_id>/add/domain/",
        AddDomainNameView.as_view(),
        name="AddDomainName",
    ),
    path(
        "chatbot/public-info/",
        ChatbotPublicInfoView.as_view(),
        name="chatbot-public-info",
    ),
    path(
        "<int:org_id>/chatbots/list/",
        AdminChatbotlistView.as_view(),
        name="AdminChatbotlist",
    ),
    path(
        "set/coupon-codes/", CouponCodeCreateView.as_view(), name="coupon-code-create"
    ),
    path(
        "set/coupon-codes/active/",
        CouponCodeListActiveView.as_view(),
        name="coupon-code-list-active",
    ),
    ...
    path(
        ...
        UpdateStaffProfileView.as_view(),
        name="update-staff-profile",
    ),
    path("logout/", LogoutView.as_view(), name="logout"),
    path("", include(router.urls)),
    path(
        "chatbots/<int:chatbot_id>/",
        include(
            [
                path("", include(faq_router.urls)),
                path(
                    "colors/",
                    ChatbotColorViewSet.as_view({"get": "list", "post": "create"}),
                    name="chatbot-colors",
                ),
            ]
        ),
